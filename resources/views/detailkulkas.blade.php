        ...
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            ...
            <ul>
                ...
                <li><a href="detailkulkasadmin.html">Kulkas</a></li>
                <li><a href="permohonankemitraanadmin.html">Permohonan Kemitraan</a></li>
                <li><a href="detaildonasiadmin.html">Donasi</a></li>
            </ul>
          </nav><!-- .navbar -->
        ...
        <div class="col-lg-3 col-md-6 footer-links d-flex">
          ...
          <div>
            ...
            <p>
              ...
              <strong>Email:</strong> hello@lesfrigossolidaires.com<br>
            </p>
          </div>
        </div>
