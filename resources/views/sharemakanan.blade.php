      ...
      <div class="card" style="border-radius: 15px;">
        <div class="card-body p-5"> 
          <form>
            ...
            <div class="form-outline mb-3">
              <input type="text" id="food" class="form-control form-control-lg" />
            ...
            <div class="form-outline mb-3">
              <input type="file" id="foto" class="form-control form-control-lg" />
              <label class="form-label" for="food">Upload File Donation</label>
            </div>
