...
>>>>>>> 27df7ce7e1807835c664e087a39ff20a0cea98cb
                <div class="row gy-4">
                  <div class="col-lg-6 col-md-6">
                    <input type="text" name="name" class="form-control" id="fname" placeholder="Your First Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                    <div class="validate"></div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <input type="text" class="form-control" name="lname" id="lname" placeholder="Your Last Name" data-rule="lname" data-msg="Please enter a valid email">
                    <div class="validate"></div>
                  </div>
                </div>
...
=======
                <p>have account? <a href="login.html">Login here!</a></p>
>>>>>>> 27df7ce7e1807835c664e087a39ff20a0cea98cb
              </form>
