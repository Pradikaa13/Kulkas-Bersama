    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          <div class="section-header">
            <p><span>Kemitraan</span></p>
          </div>
          <div class="row">
            <div class="col">
              <div class="embed-responsive embed-responsive-21by9">
                  <img src="kemitraan.jpg" alt="" width="600" height="400px">
              </div>
            </div>
            <div class="col">
              <p style="text-align: justify;">
                ...
                <a class="btn btn-danger" href="{{ ('pengajuankemitraan') }}" role="button">Pengajuan Kemitraan</a>
            </div>
